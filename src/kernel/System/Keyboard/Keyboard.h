...
class Keyboard
{
    ...
    static bool IsKeyPressed(uint_8 key);
    static bool IsKeyCharPressed(uint_8 key);
    static uint_8 GetKeyCode();
    static uint_8 GetKeyCodeStatic();
    static uint_8 GetChar();
    static uint_8 KeyPressed[128];
    ...
    struct KEY
    {
        ...
        KEY(uint_8 hex, char scancode, uint_32 index)
        {
            this->hex = hex;
